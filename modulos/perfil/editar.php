<div class="col-md-9 pull-right conteudo">
	<div class="fluid content">
    	<section>
            <h1><span class="glyphicon glyphicon-user"></span>&nbsp;Editar Perfil</h1>
            <h4 class="sub-title">Gerenciar as informações do seu perfil.</h4>
            
            <div class="box">
            	<div class="box-title">
                	<h3 class="box-title-title"><span class="glyphicon glyphicon-refresh"></span>&nbsp;&nbsp;Perfil</h3>
                </div>
