<div class="col-md-9 pull-right conteudo">
	<div class="fluid content">
    	<section>
            <h1><span class="glyphicon glyphicon-globe"></span>&nbsp;Novo Post</h1>
            <h4 class="sub-title">Adicionar um novo post para o Blog.</h4>
            
            <div class="box">
            	<div class="box-title">
                	<h3 class="box-title-title"><span class="glyphicon glyphicon-pencil"></span>&nbsp;&nbsp;Informações do Post</h3>
                </div>
                ...
                <div class="box-content">
                	<form>
                        <div class="control-group row">
                            ...
                            <div class="col-sm-10">
                            	<input type="text" class="form-control" placeholder="example-post-teste">
                            </div>
                        </div><br>
                    </form>
                </div>
